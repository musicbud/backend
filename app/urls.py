...
from .views.get_common import (
    ...
    get_common_top_anime,
    get_common_top_manga
)
...
from .views.get_buds_by_top import (
    get_buds_by_top_artists,
    get_buds_by_top_tracks,
    get_buds_by_top_genres,
    get_buds_by_top_anime,
    get_buds_by_top_manga
)

from .views.get_buds_by_liked import (
    get_buds_by_liked_artists,
    get_buds_by_liked_tracks,
    get_buds_by_liked_genres,
    get_buds_by_liked_albums,
    get_buds_by_played_tracks
)
...
urlpatterns = [
    ...
    path('bud/common/top/tracks', get_common_top_tracks.as_view(), name='get_common_top_tracks'), 
    path('bud/common/top/genres', get_common_top_genres.as_view(), name='get_common_top_genres'), 
    path('bud/common/top/anime', get_common_top_anime.as_view(), name='get_common_anime'), 
    path('bud/common/top/manga', get_common_top_manga.as_view(), name='get_common_manga'), 
    ...
    path('me/top/anime', get_top_anime.as_view(), name='get_top_anime'), 
    path('me/top/manga', get_top_manga.as_view(), name='get_top_manga'), 
    ...
    path('bud/top/anime', get_buds_by_top_anime.as_view(), name='get_buds_by_top_anime'),
    path('bud/top/manga', get_buds_by_top_manga.as_view(), name='get_buds_by_top_manga'),
    ...
    path('bud/album', get_buds_by_album.as_view(), name='get_buds_by_album'),
